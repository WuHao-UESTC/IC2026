...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{state_flow.png}
\caption{双极性SAR状态机流程}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{spi_seq.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{sample_logic_seq.png}
